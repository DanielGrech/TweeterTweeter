...
public class ActionBarCompat extends RelativeLayout implements OnClickListener {
	...
	public static class FragmentAction extends AbstractAction {
		//private Context mContext;
		private Fragment mFragment;
		private int mFragmentContainer;
		private FragmentManager mFragmentManager;

		public FragmentAction(Context context, Fragment fragment, int fragContainer, FragmentManager fragmentManager, int drawable) {
			super(drawable);
			//mContext = context;
			mFragment = fragment;
			mFragmentManager = fragmentManager;
			mFragmentContainer = fragContainer;
		}
		...
		public void performAction(View view) {            
			try{
				...
				//Occurs when we press the home button when 
				//we are already showing fragment
				e.printStackTrace();
			}
		}
	}
