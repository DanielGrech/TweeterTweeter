...
import com.DGSD.TweeterTweeter.Utils.MotionEventUtils;
import com.DGSD.TweeterTweeter.Utils.ReflectionUtils;
...
public class Workspace extends ViewGroup {
	...
	private void initWorkspace() {
		...
		mPagingTouchSlop = ReflectionUtils.callWithDefault(configuration,
				"getScaledPagingTouchSlop", mTouchSlop * 2) * 2;
		...
		switch (action & MotionEventUtils.ACTION_MASK) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if(ev.getPointerCount() > 1){
					//Dont scroll if we are touching with
